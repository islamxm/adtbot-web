        ...
        <div className={styles.wrapper}>
            <Row gutter={[35,35]}>
                ...
                <Col span={24}>
                    ...
                    <br/>
                    4. Администрация ADTBot оставляет за собой право пересмотреть условия предоставления партнерской программы.
                    <br/>
                    <br/>
                    <br/>
                    Пользователи, зарегистрированные по партнерской ссылке:
                    <br/>
                    <br/>
                    1. vlgg****lf  —  Активен
                    <br/>
